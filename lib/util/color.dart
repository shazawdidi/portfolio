...
const primaryColor = Color(0xFF075B9A);
const primaryColor2 = Color(0xFF548AB6);

const secondaryPrimaryColor = Color(0xffffffff);
const secondaryColor = Color(0xfff4b234);
const secondary2Color = Color(0xffe74f1f);
...
const scaffoldColorDark = Color(0xFF020202);
...
const pendingApprovalColor = Color(0xFFFD6922);
